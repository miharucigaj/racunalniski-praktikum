...
\end{figure}
    ...
    % Začetek definicije
    \begin{definicija}
        \label{definicija: standardno brownovo gibanje}
    ...
    % Začetek definicije
    \begin{definicija}
    Slučajna spremenljivka $\tau$ na verjetnostnem prostoru \f z vrednostmi v \f
    je čas ustavljanja glede na filtracijo \f, če velja \f.
    \end{definicija}
    ...
    Naj bo $\{B_t\}_{t \geq 0}$\f (standardno) Brownovo gibanje, \f čas ustavljanja glede na 
    \f in naj bo \f.
